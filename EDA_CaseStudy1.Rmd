...
Here, we can note that wild isolates show a clear advantage over lab strains in some particular markers and contribute to more growth in a strain, specially in **YPMalt**, more than any other enviroment.
...
By computing the differences between the growth medians for wild strains and lab isolates for every marker, we noticed that the genotype in the environments **YPD** and **YPE** had a very similar effect on growth specially with the markers: **10675**, **10688**, **10702**, **10715**, **10728** and **10755**.
