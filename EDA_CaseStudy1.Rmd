...
To sum up, we can conclude that genotype does most certainly affect fitness, but only for specific markers, which also varies according to the environment. Furthermore, when genotype matters it is in favor of a wild isolate yeast strain most of the time. YPD (peptone dextrose) is overall the best environment for growth. However, in YPMalt (maltose), a wild strain has the most significant effect on growth in comparison to other environments including YPD (peptone dextrose). In addition to that, the same markers seem to have the same effect on growth in the environments YPD (peptone dextrose) and YPE (ethanol) and the reasons for this are definitely worth investigating.
