...
It's clear to us that this plot shows only the growth variation per environment and misses out the variation due to genotype.To follow up, we plot the median growth per marker in YPD.
