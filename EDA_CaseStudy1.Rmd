...
Note how the color (RNA value) changes over Genes, showing that the amount of RNA produced at each gene differ. The color (RNA Value) also changes from one medium to another for any given gene. It can also be clearly seen that the RNA value differs more per gene than per medium, showing that transcription is affected more by genetic than environmental influences for chromosome 01 of segregant 47C.
